...
<nav class="navbar animate top">
    <div class="container">
        <div class="area-logo"> <a href="http://casadopastel.com.br/"><img src="images/logoCasaDoPastel.png" alt="Casa do Pastel - Santa Maria"> </a> </div>
...
<section id="middle">
    <div class="container">
        <div id="middle-row" class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top"> <img class="wow fadeInUp" src="images/middle-facebook.png" alt="Curta no Facebook"> </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top"> <img class="wow fadeInUp" src="images/middle-endereco.png" alt="Nossos Endereços"> </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top"> <img class="wow fadeInUp" src="images/middle-delivery.png" alt="Delivery"> </div>
        </div>
        <div id="peca-site" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding animate top"> <img class="wow fadeInUp" id="img-peca-site" src="images/middle-peca-site.png" alt="Peça pelo Site"> </div>
    </div>
</section>
<div class="clearfix"></div>
<section id="cardapio">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="content white">
                    <nav class="navbar" role="navigation">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                            <ul class="nav navbar-nav">
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pastéis <b class="caret"></b></a>
                                    <ul class="dropdown-menu">
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Novos Sabores</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Brócilis</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Calabresa</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Camarão</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Carne</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Chester</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Coração</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Frango</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Lombo</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Palmito</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Presunto</a></li>
                                        <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3 seta-ativo"> <a onclick="menuList('pasteis')">Queijo</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pastéis Doces<b class="caret"></b></a>
                    ...
                    <!--/.navbar-->
                    <img src="../images/beach-backpacks.jpg" alt="Beach Backpacks" />
                </div>
                <!--/.content-->
            </div>
        </div>
        <div class="row animate bottom" id="cardapio-itens">
            ...
            <div class="list-pasteis">
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis-p3')"><img src="images/cardapio-button-left.png" alt="Voltar"></a> <a id="right" onclick="menuList('pasteis-p2')"><img src="images/cardapio-button-right.png"
                                                                                                                                                                                                            alt="Próxima"></a> </div>
            </div>
            <div class="list-pasteis-p2 hide">
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis')"><img src="images/cardapio-button-left.png"
                                                                                             alt="Voltar"></a> <a id="right" onclick="menuList('pasteis-p3')"><img src="images/cardapio-button-right.png"
                                                                                                                                                                   alt="Próxima"></a> </div>
            </div>
            <div class="list-pasteis-p3 hide">
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis-p2')"><img src="images/cardapio-button-left.png"
                                                                                                alt="Voltar"></a> <a id="right" onclick="menuList('pasteis')"><img src="images/cardapio-button-right.png"
                                                                                                                                                                   alt="Próxima"></a> </div>
            </div>
            <!-- FIM PASTEIS-->
            ...
            <div class="list-pasteis-lights hide">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="cardapio-box-item">
                    <h1>PEITO DE PERU</h1>
                    <p>Peito de peru, molho branco, milho verde, ervilha, cebola cozida sem sal, tomate, queijo mussarela, orégano</p>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="cardapio-box-item">
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis-lights')"><img src="images/cardapio-button-left.png"
                                                                                                    alt="Voltar"></a> <a id="right" onclick="menuList('pasteis-lights')"><img src="images/cardapio-button-right.png"
                                                                                                                                                                              alt="Próxima"></a> </div>
            </div>
            <!-- FIM PASTEIS LIGHTS-->
            <div class="clearfix"></div>
            ...
            <div class="list-pasteis-doces hide">
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis-doces-p2')"><img src="images/cardapio-button-left.png"
                                                                                                      alt="Voltar"></a> <a id="right" onclick="menuList('pasteis-doces-p2')"><img src="images/cardapio-button-right.png"
                                                                                                                                                                                  alt="Próxima"></a> </div>
            </div>
            <div class="list-pasteis-doces-p2 hide">
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis-doces')"><img src="images/cardapio-button-left.png"
                                                                                                   alt="Voltar"></a> <a id="right" onclick="menuList('pasteis-doces')"><img src="images/cardapio-button-right.png"alt="Próxima"></a> </div>
            </div>
            <!-- FIM PASTEIS DOCES-->
            <div class="clearfix"></div>
            <div class="list-sanduiches hide">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="cardapio-box-item">
                    <h1>LIGHT I</h1>
                    <p>Pasta de ricota, chester fatiado e defumado, tomate seco, alface, cenoura ralada e pão integral</p>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="cardapio-box-item">
                    <h1>LIGHT II</h1>
                    <p>Pasta de ricota temperada (tempero verde, azeitona), cenoura ralada, alface, tomate, palmito e pão integral</p>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="cardapio-box-item">
                    <h1>LOMBO</h1>
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('sanduiches-p2')"><img src="images/cardapio-button-left.png"
                                                                                                   alt="Voltar"></a> <a id="right" onclick="menuList('sanduiches-p2')"><img src="images/cardapio-button-right.png"alt="Próxima"></a> </div>
            </div>
            <div class="list-sanduiches-p2 hide">
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('sanduiches')"><img src="images/cardapio-button-left.png"
                                                                                                alt="Voltar"></a> <a id="right" onclick="menuList('sanduiches')"><img src="images/cardapio-button-right.png"alt="Próxima"></a> </div>
            </div>
            <div class="clearfix"></div>
            ...
            <div class="list-porcoes-extras hide">
                ...
                <div class="cardapio-setas">
                    <a id="left" onclick="menuList('porcoes-extras-p3')"><img src="images/cardapio-button-left.png"
                                                                              alt="Voltar"></a>
                    <a id="right" onclick="menuList('porcoes-extras-p2')"><img src="images/cardapio-button-right.png"alt="Próxima"></a>
                </div>
            </div>
            <div class="list-porcoes-extras-p2 hide">
                ...
                <div class="cardapio-setas">
                    <a id="left" onclick="menuList('porcoes-extras')"><img src="images/cardapio-button-left.png"
                                                                           alt="Voltar"></a>
                    <a id="right" onclick="menuList('porcoes-extras-p3')"><img src="images/cardapio-button-right.png"alt="Próxima"></a>
                </div>
            </div>
            <div class="list-porcoes-extras-p3 hide">
                ...
                <div class="cardapio-setas">
                    <a id="left" onclick="menuList('porcoes-extras-p2')"><img src="images/cardapio-button-left.png"
                                                                              alt="Voltar"></a>
                    <a id="right" onclick="menuList('porcoes-extras')"><img src="images/cardapio-button-right.png"alt="Próxima"></a>
                </div>
            </div>
            <div class="clearfix"></div>
            ...
            <div class="list-combokids hide">
                ...
                <div class="cardapio-setas">
                    <a id="left" onclick="menuList('combokids')"><img src="images/cardapio-button-left.png"
                                                                      alt="Voltar"></a>
                    <a id="right" onclick="menuList('combokids')"><img src="images/cardapio-button-right.png"alt="Próxima"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top">
            ...
            <ul class="info">
                ...
                <li><i class="fa fa-phone fa-lg" aria-hidden="true"></i> (55) <div class="telefone">3218 1008</div></li>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top">
            ...
            <ul class="info">
                ...
                <li><i class="fa fa-phone fa-lg" aria-hidden="true"></i> (55) <div class="telefone">3217 4037</div></li>
                <li><i class="fa fa-clock-o fa-lg" aria-hidden="true"></i> Segunda a Domingo: 19:00 hs - 00:00 hs</li>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top">
            ...
            <ul class="info">
                <li><i class="fa fa-map-marker fa-lg" aria-hidden="true"></i> Ângelo Bolson,338 | Santa Maria,RS
                    ...
                    ></li>
                <li><i class="fa fa-phone fa-lg" aria-hidden="true"></i> (55) <div class="telefone">3218 6426</div></li>
                <li><i class="fa fa-clock-o fa-lg" aria-hidden="true"></i> Segunda a Domingo: 19:00 hs - 00:00 hs</li>
            </ul>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top">
            ...
            <ul class="info">
                <li><i class="fa fa-map-marker fa-lg" aria-hidden="true"></i> Av. das Rendeiras,1228 - Lagoa da Conceição
                    <a onClick="showMap('#mapLagoa')" id="mapa">Ver no mapa</a><br>
                </li>
                <li><i class="fa fa-phone fa-lg" aria-hidden="true"></i> (48) <div class="telefone">3207 5794</div></li>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top">
            ...
            <ul class="info">
                ...
                <li><i class="fa fa-phone fa-lg" aria-hidden="true"></i> (48) <div class="telefone">3234 9411</div></li>
                <li><i class="fa fa-clock-o fa-lg" aria-hidden="true"></i> Segunda a Domingo: 19:00 hs - 00 hs</li>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 animate top">
            ...
            <ul class="info">
                ...
                <li class="txt-normal">Visa, Mastercard, Hipercard, Banricompras, Ticket Restaurante, Alelo(elo), Redecard, Visa Vale Refeição, Diners, Refeisul.
                </li>
...
<div class="mapa">
    <div id="closeBarX" class="barClose col-sm-12" onClick="hideMapa();"><span class="closeBarLocalTxt hidden-md hidden-lg">Localização</span> <i class="fa fa-close"></i></div>
    <!-- Ag Bolson -->
