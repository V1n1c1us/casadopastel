    ...
    <div class="container">
                ...
                <ul class="nav navbar " id="cardapio-menu">
                    ...
                    <li class="dropdown col-md-2">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Calabresa</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Camarão</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Carne</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Chester</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Coração</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Frango</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Lombo</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Palmito</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Presunto</a></li>
                            <li class="col-md-12 menu-pasteis menu-pasteis-p2 menu-pasteis-p3"> <a onclick="menuList('pasteis')">Queijo</a></li>
                        </ul>
                    </li>
                    <li class="col-md-2 menu-pasteis-lights menu-pasteis-lights-p2"><a
                            onclick="menuList('pasteis-lights')">Pastéis Lights</a> </li>
                    <li class="col-md-2 menu-pasteis-doces menu-pasteis-doces-p2"><a onclick="menuList('pasteis-doces')">Pasteis Doces</a></li>
                    <li class="col-md-2 menu-sanduiches"><a onclick="menuList('sanduiches')">Sanduíches</a></li>
                    <li class="col-md-2 menu-porcoes-extras"><a onclick="menuList('porcoes-extras')"><span class="hidden-md hidden-sm">Porções </span>Extras</a></li>
        ...
        <div class="row animate bottom" id="cardapio-itens">
            ...
            <div class="list-pasteis-novos">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="cardapio-box-item">
                    <h1>PAPAI BIG PIG</h1>
                    <p>Lombo de porco assado, azeitona, champignon, milho, bacon, mussarela, provolone, parmesão e catupiry</p>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="cardapio-box-item">
                    <h1>DO CHEFE</h1>
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis-p3')"><img src="images/cardapio-button-left.png" alt="Voltar"></a> <a id="right" onclick="menuList('pasteis-novos-p2')"><img src="images/cardapio-button-right.png"
                                                                                                                                                                                                            alt="Próxima"></a> </div>
            </div>
            <div class="list-pasteis-novos-p2 hide">
                ...
                <div class="clearfix"></div>
                <div class="cardapio-setas"> <a id="left" onclick="menuList('pasteis-novos')"><img src="images/cardapio-button-left.png"
                                                                                             alt="Voltar"></a> <a id="right" onclick="menuList('pasteis-novos-p3')"><img src="images/cardapio-button-right.png"
                                                                                                                                                                   alt="Próxima"></a> </div>
            </div>
            <div class="list-pasteis-novos-p3 hide">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" id="cardapio-box-item">
